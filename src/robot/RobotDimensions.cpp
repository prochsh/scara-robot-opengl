...
RobotDimensions::RobotDimensions(double _armWidth, double _armHeight, double _armDeep) {
	...
	armBaseY = armWidth;
	armBaseZ = armDeep;
    clawBaseRadius = armDeep/1.7;
    clawBaseHeight = armDeep;
    clawBaseX = clawBaseRadius/2;//-ringRadius;//armDeep;
    clawBaseY = -ringHeight;//0;//armWidth;
    clawBaseZ = ringRadius;//0;//armDeep;
    handWidth = armWidth;
